...
<g>
	<g onClick={!preview ? (e) => openPicker(e, { type: "color", target:"peau", value: peau}) : undefined} style={{ cursor: "pointer" }}>
	...
	<path fill={levres} stroke="#000" onClick={!preview ? (e) => openPicker(e, { type: "color", target:"levres", value: levres}) : undefined} style={{ cursor: "pointer" }} d="M432.6,199.8c-8.8,0.2-13.5-4.3-15.7-4.4c-2.2-0.1-3.9,3.1-3.9,3.1s-1.8-3.1-4.2-3.1c-2.4,0-6.1,4.3-16.3,4.6
	...
	<g onClick={!preview ? (e) => openPicker(e, { type: "color", target:"yeux", value: yeux}) : undefined} style={{ cursor: "pointer" }}>
