...
const HautSalopette = ({ color, width = 250, height = 210, onPickColor }) => {
    return (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg"  
           width={width} height={height} viewBox="-23 0 250 210" className="svg"
           style={{ cursor: "pointer" }}
      >
        <polygon fill="#fff" stroke='#000' points="81.9 54.7 78.8 23.1 85.7 22.5 89.9 54.8 81.9 54.7"/>
        <polygon fill="#fff" stroke='#000' points="141 54.8 143.9 23.1 137 22.5 133 55 141 54.8"/>
        <g fill="#fff">
